-- =============================================================================
-- V67: Seed full 180 continuous days of demand history for DSS (No zero gap)
--
...
--
-- Full 180 continuous days: CURRENT_DATE - 179 … CURRENT_DATE
-- =============================================================================
    ...
    SELECT GREATEST(
        ...
        ROUND(
            CASE product.profile_name
                -- 1. DOWNWARD: 14.0 -> 2.5 across 180 days (Slope < -0.02)
                WHEN 'DOWNWARD' THEN
                ...
                -- 3. UPWARD: 2.5 -> 12.0 across 180 days (Slope > +0.02)
                WHEN 'UPWARD' THEN
