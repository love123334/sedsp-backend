...
CREATE INDEX IF NOT EXISTS idx_demand_predictions_product
    ON demand_predictions (product_id);

CREATE INDEX IF NOT EXISTS idx_demand_predictions_generated_by
    ON demand_predictions (generated_by);

CREATE INDEX IF NOT EXISTS idx_demand_predictions_created_at
